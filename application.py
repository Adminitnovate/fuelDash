...
server = application.server  # used by gunicorn in production mode
...
# The app layout
application.layout = html.Div(className='app-body', children=[
    # Stores
    ...
    html.Div(className="row", children=[
        html.Div(className='twelve columns', children=[
            ...
            html.Div(style={'float': 'right'}, children=[
                html.A(
                    html.Img(
                        src=application.get_asset_url("vaex-logo.png"),
                        style={'float': 'right', 'height': '35px', 'margin-top': '20px'}
                    ),
                    href="https://vaex.io/"),
                html.A(
                    html.Img(
                        src=application.get_asset_url("dash-logo.png"),
...
# Map figure
@application.callback([Output('heatmap_figure', 'figure'),
...
@application.callback([Output('map_clicks', 'data'),
...
@application.callback(Output('zone', 'data'),
...
@application.callback([Output('geomap_figure', 'figure'),
...
@application.callback([Output('trip_summary_amount_figure', 'figure'),
